...
function getCSS(node){
    ...
    visual_cues["float"] = style.getPropertyValue("float");
    visual_cues["margin-top"] = style.getPropertyValue("margin-top");
    visual_cues["margin-bottom"] = style.getPropertyValue("margin-bottom");
